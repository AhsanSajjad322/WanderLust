...
app.use((req,res,next)=>{
    // These locals variables are accessible to ejs template
...
//         username: "student" 
//     })
//     // To store user, it automatically saves user to DB with the password
...
//     res.cookie("Father", "Sajjad");
//     res.send("Cookie sent");
// })

// app.get('/getsignedcookie',(req,res)=>{
//     res.cookie('made-in', "Pak",{ signed : true })
